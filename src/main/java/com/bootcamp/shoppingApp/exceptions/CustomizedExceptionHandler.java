...
public class CustomizedExceptionHandler {
    ...
    public final ResponseEntity<Object> handleContactInvalidException(InvalidContactException ex, WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
                request.getDescription(false));
    ...
    public final ResponseEntity<Object> handleContactInvalidException(InvalidPasswordException ex, WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
                request.getDescription(false));
        return new ResponseEntity(exceptionResponse, HttpStatus.BAD_REQUEST);
    }
